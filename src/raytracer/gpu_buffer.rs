...
impl UniformBuffer {
    pub fn new(device: &wgpu::Device, buffer_size: wgpu::BufferAddress, binding_idx: u32, label: Option<&str>) -> Self {
...
impl StorageBuffer {
    ...
    pub fn layout(&self, visibility: wgpu::ShaderStages, read_only: bool) -> wgpu::BindGroupLayoutEntry {
        wgpu::BindGroupLayoutEntry {
            binding: self.binding_idx,
            visibility,
            ty: wgpu::BindingType::Buffer {
